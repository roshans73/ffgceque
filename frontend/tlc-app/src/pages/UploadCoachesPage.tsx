...
const UploadCoachesPage: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    setResult(null);
    try {
      const r = await apiClient.uploadCoaches(file);
      setResult(r.data);
    } catch {
  ...
  return (
    <Box>
      ...
      <Typography variant="body2" color="textSecondary" sx={{ mb: 3 }}>
        Upload an Excel (.xlsx) file with columns: DistrictId, BlockId, EmpNo, Name
      </Typography>
...
export default UploadCoachesPage;
