...
const UploadTeachersPage: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    setResult(null);
    try {
      const r = await apiClient.uploadTeachers(file);
      setResult(r.data);
    } catch {
  ...
  return (
    <Box>
      ...
      <Typography variant="body2" color="textSecondary" sx={{ mb: 3 }}>
        Upload an Excel (.xlsx) file with columns: Name, School, DistrictId, BlockId, Gender, Mobile, Email, IsTipTeacher (Y/N), YearsInTip
      </Typography>
...
export default UploadTeachersPage;
