...
const UsersPage: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        // Only send Azure AAD ID when explicitly provided
        azureAadId: form.azureAadId.trim() || undefined,
      };
      ...
      let message =
        "Failed to save user. Check that the email is not already registered.";
  ...
  const roleName = (roleId: number) =>
    getRoleById(roleId)?.label ?? `Role ${roleId}`;
